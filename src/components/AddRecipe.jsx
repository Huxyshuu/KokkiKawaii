  ...
  if (!recipeSent) {
    ...
    return (
      <div id="failedRecipe">
        ...
        <p id="failInfo" onClick={() => window.location = "mailto:hugotamm@hotmail.com?subject=Problem adding a recipe - KokkiKawaii"}>@: <span style={{textDecoration: "underline"}}>hugotamm@hotmail.com</span></p>
      </div>
    )
  }
}
